...
(2006-2011).Features have hourly average ambient variables Temperature (T),Ambient Pressure (AP),
...
with the input data of hourly average ambient variables Temperature (T),Ambient Pressure (AP),
